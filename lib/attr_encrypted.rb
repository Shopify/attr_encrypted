...
module AttrEncrypted
  ...
  def self.extended(base) # :nodoc:
    base.class_eval do
      ...
      @attr_encrypted_options, @encrypted_attributes_custom = {}, {}
    end
  end
  ...
  def attr_encrypted(*attributes)
    ...
    attributes.each do |attribute|
      ...
      encrypted_attributes_custom[attribute.to_sym] = options.merge(attribute: encrypted_attribute_name)
    end
  end
  ...
  def attr_encrypted?(attribute)
    encrypted_attributes_custom.has_key?(attribute.to_sym)
  end
  ...
  def decrypt(attribute, encrypted_value, options = {})
    options = encrypted_attributes_custom[attribute.to_sym].merge(options)
  ...
  #   end
  #
  #   User.encrypted_attributes_custom # { email: { attribute: 'encrypted_email', key: 'my secret key' } }
  def encrypted_attributes_custom
    @encrypted_attributes_custom ||= superclass.encrypted_attributes_custom.dup
  end
  ...
  module InstanceMethods
    ...
    def decrypt(attribute, encrypted_value)
      encrypted_attributes_custom[attribute.to_sym][:operation] = :decrypting
      encrypted_attributes_custom[attribute.to_sym][:value_present] = self.class.not_empty?(encrypted_value)
    ...
    def encrypt(attribute, value)
      encrypted_attributes_custom[attribute.to_sym][:operation] = :encrypting
      encrypted_attributes_custom[attribute.to_sym][:value_present] = self.class.not_empty?(value)
    ...
    #
    def encrypted_attributes_custom
      @encrypted_attributes_custom ||= begin
        duplicated= {}
        self.class.encrypted_attributes_custom.map { |key, value| duplicated[key] = value.dup }
        duplicated
      end
    end
    ...
    protected
      ...
      def evaluated_attr_encrypted_options_for(attribute)
        ...
        attributes = encrypted_attributes_custom[attribute.to_sym]
