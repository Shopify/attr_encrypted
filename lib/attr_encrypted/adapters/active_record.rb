      ...
      module ActiveRecord
        def self.extended(base) # :nodoc:
          base.class_eval do
            ...
            def reload(*args, &block)
              ...
              self.class.encrypted_attributes_custom.keys.each do |attribute_name|
            ...
            def perform_attribute_assignment(method, new_attributes, *args)
              ...
              send method, new_attributes.reject { |k, _|  self.class.encrypted_attributes_custom.key?(k.to_sym) }, *args
              send method, new_attributes.reject { |k, _| !self.class.encrypted_attributes_custom.key?(k.to_sym) }, *args
            end
        ...
        protected
          ...
          def attr_encrypted(*attrs)
            ...
            options.merge! encrypted_attributes_custom[attr]
          ...
          def method_missing_with_attr_encrypted(method, *args, &block)
            if match = /^(find|scoped)_(all_by|by)_([_a-zA-Z]\w*)$/.match(method.to_s)
              ...
              attribute_names.each_with_index do |attribute, index|
                if attr_encrypted?(attribute) && encrypted_attributes_custom[attribute.to_sym][:mode] == :single_iv_and_salt
                  args[index] = send("encrypt_#{attribute}", args[index])
                  warn "DEPRECATION WARNING: This feature will be removed in the next major release."
                  attribute_names[index] = encrypted_attributes_custom[attribute.to_sym][:attribute]
                end
              end
